export function TodoBlock({ block }) {
  ...
  return (
    <div className="flex min-w-0">
      <div className="grid w-full gap-2.5 rounded-[24px] border border-[#dce6f8] bg-[linear-gradient(180deg,#fbfcff_0%,#f5f8ff_100%)] px-5 py-4 shadow-[0_16px_34px_rgba(15,23,42,0.05)]">
        <div className="flex items-center gap-2">
          <div className="rounded-full bg-[#eef4ff] px-2.5 py-1 text-[11px] font-bold tracking-[0.12em] text-[#3566df]">待办列表</div>
          <span className="rounded-full border border-[#dbe5f6] bg-white px-2 py-1 text-[10px] text-[#8a96ab] shadow-[0_6px_16px_rgba(15,23,42,0.04)]">{block.status}</span>
        </div>
