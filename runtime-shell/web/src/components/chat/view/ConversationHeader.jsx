...
export const ConversationHeader = memo(function ConversationHeader({ currentSessionId, sessionTitle, onOpenSettings }) {
  ...
  return (
    <header className="shrink-0 flex items-center justify-between gap-3 px-4 py-3 rounded-[20px] border border-[var(--line)] bg-[var(--surface)] shadow-md backdrop-blur-2xl">
      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        <button
          ...
          aria-label="打开设置"
          className="text-xs px-3 py-1.5 rounded-[8px] bg-black/20 text-[var(--text-dim)] border border-[var(--line)] hover:bg-black/35 transition-colors focus-visible:ring-2 focus-visible:ring-brand"
        >
          设置
        </button>
      </div>
