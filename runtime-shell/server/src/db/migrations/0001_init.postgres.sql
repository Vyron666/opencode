...
CREATE INDEX IF NOT EXISTS idx_workspace_binding_cleanup_prefix ON workspace_binding (tenant_id, organization_id, created_by, name, deleted_at);
...
CREATE INDEX IF NOT EXISTS idx_business_session_scope_updated ON business_session (tenant_id, organization_id, project_id, deleted_at, updated_at DESC);
CREATE INDEX IF NOT EXISTS idx_business_session_workspace_status ON business_session (workspace_binding_id, status, deleted_at, updated_at DESC);
